...
CREATE TABLE EVENTO (
	...
	CONSTRAINT CK_EVENTO_0 CHECK (MAX_PARTICIPANTES IS NULL OR MAX_PARTICIPANTES >= MIN_PARTICIPANTES),
	CONSTRAINT CK_EVENTO_1 CHECK (MIN_PARTICIPANTES >= 2),
	CONSTRAINT CK_EVENTO_2 CHECK (DATA_HORA_CRIACAO < DATA_HORA_EVENTO)
);
